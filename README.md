...
- **Secure Architecture**: JWT-hardened API, Zod-validated schemas, and indexed `better-sqlite3` tables for high-performance persistence.

## 🛠 Tech Stack

- **Frontend**: React 19, Vite, TypeScript, Tailwind CSS, shadcn/ui, TanStack Query, Framer Motion.
- **Backend**: Node.js, Express 5.2, Socket.io, JWT, bcryptjs, Zod, Helmet.
- **Database**: SQLite (`better-sqlite3`) with optimized indexing.
