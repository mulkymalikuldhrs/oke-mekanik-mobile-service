...
## 🔮 Futuristic Vision
Oke Mekanik is not just a service app; it's a "Future Mechanic Ecosystem". We utilize:
- **Holographic UI**: Advanced Glassmorphism and Framer Motion for a next-gen feel.
- **Neural Diagnostics**: AI-powered problem analysis to predict vehicle needs.
- **Real-time Synchronization**: Persistent SQLite backend for zero-latency operations.
- **Autonomous Architecture**: A production-ready environment that thrives on architectural integrity.

## 🚀 Features

- **Futuristic UI/UX**: Holographic Glassmorphism design using Tailwind CSS and Framer Motion.
- **AI Smart Diagnostic**: Automated problem analysis to recommend the most suitable service.
- **Real-Time Tracking**: GPS-based mechanic tracking using Leaflet and TanStack Query.
