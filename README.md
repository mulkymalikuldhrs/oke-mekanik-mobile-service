...
- **Real-time Discovery**: Functional Leaflet-based map tracking for monitoring mechanic locations in real-time.
...
- `server/`: Express backend and SQLite database configuration (`better-sqlite3`).
