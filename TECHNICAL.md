# 🛠️ Oke Mekanik - Technical Architecture (v5.8.0 ULTIMATE+)
...
// Add technical term boosts (+30 points for v5.8.0)
...
- **`svc-4` (Tune Up)**: `brebet`, `pincang`, `ngelitik`, `ngeden`, `asap putih/hitam`, `ngobos`, `injector`, `bore up`, `overhaul`.
