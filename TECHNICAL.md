...
- **`svc-1` (Oil Change)**: `oli meler`, `oli rembes`, `oil seal`, `karter`, `oil pump`, `filter oli mampet`.
- **`svc-4` (Tune Up)**: `brebet`, `pincang`, `ngelitik`, `ngeden`, `asap putih/hitam`, `ngobos`, `injector`, `bore up`, `overhaul`, `turun mesin`, `packing head`.
- **`svc-5` (Electrical)**: `limp mode`, `check engine`, `korslet`, `ecu`, `sekring putus`, `short circuit`, `grounding`, `sensor crankshaft`, `immobilizer`.
- **`svc-2` (Routine/Suspension)**: `gluduk`, `kaki-kaki`, `setir narik`, `v-belt`, `cv joint`, `bushing arm`, `tierod oblak`, `rack steer`.
...
1. **AI Verification**: `node tests/verify_ai_v58.js`
