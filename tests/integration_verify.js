...
async function verifyBackend() {
  ...
  const testCases = [
    ...
    { problem: 'ban saya benjol dan sudah retak', expected: 'Ganti Ban' },
    { problem: 'mesin mobil ngelitik dan getar parah', expected: 'Tune Up' },
    { problem: 'ac mobil cuma anget dan berisik', expected: 'Isi Freon AC' }
  ];
