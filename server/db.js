...
const seedData = () => {
  ...
  if (userCount === 0) {
    ...
    insertUser.run('cust-1', 'John Customer', 'customer@example.com', hashedPwd, 'customer');
    insertUser.run('mech-1-user', 'Jane Mechanic', 'mechanic@example.com', hashedPwd, 'mechanic');
