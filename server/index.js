...
// --- AI Diagnostic Engine (v4.0 Advanced Weighted & Deep Technical Analysis) ---
const AI_MODEL = [
  { id: 'svc-7', name: 'Cek Aki', keywords: { aki: 10, battery: 10, stater: 8, tekor: 9, soak: 10, mati: 2, 'nggak nyala': 7, drop: 8, 'stater berat': 9, 'voltase': 7, 'alternator': 5 } },
  { id: 'svc-1', name: 'Ganti Oli', keywords: { oli: 10, oil: 10, pelumas: 8, bocor: 4, hitam: 5, kental: 5, 'suara kasar': 6, 'mesin panas': 4, 'filter oli': 7, 'seal': 5 } },
  { id: 'svc-3', name: 'Ganti Ban', keywords: { ban: 10, bocor: 9, tire: 10, kempes: 9, gundul: 8, pecah: 7, meletus: 9, 'kurang angin': 5, 'velg': 4, 'pentil': 5, 'tubeless': 6 } },
  { id: 'svc-6', name: 'Ganti Kampas Rem', keywords: { rem: 10, brake: 10, cit: 8, mencit: 9, pakem: 8, bunyi: 4, decit: 10, blong: 10, 'rem bunyi': 9, 'piringan': 6, 'minyak rem': 7, 'kaliper': 5 } },
  { id: 'svc-8', name: 'Isi Freon AC', keywords: { ac: 10, freon: 10, panas: 7, dingin: 8, bau: 5, gerah: 4, 'ac mati': 9, 'nggak dingin': 10, 'kompresor': 6, 'evaporator': 6, 'filter ac': 5 } },
  { id: 'svc-5', name: 'Cek Kelistrikan', keywords: { listrik: 10, lampu: 9, kabel: 8, konslet: 10, sekring: 9, mati: 3, sensor: 7, 'putus': 6, 'korslet': 10, 'ecu': 8, 'koil': 7, 'busi': 8, 'spul': 7 } },
  { id: 'svc-4', name: 'Tune Up', keywords: { mesin: 9, overheat: 10, asap: 8, brebet: 10, pincang: 10, mati: 5, ngadat: 10, bensin: 4, boros: 6, 'mogok': 10, 'tarikan berat': 9, 'injeksi': 9, 'karburator': 9, 'piston': 8, 'klep': 8, 'radiator': 10, 'kopling': 10, 'transmisi': 10, 'persneling': 9, 'gigi susah': 9, 'v-belt': 7, 'cvt': 7, 'air radiator': 8, 'selang radiator': 8 } },
  { id: 'svc-2', name: 'Servis Rutin', keywords: { rutin: 10, servis: 10, service: 10, berkala: 9, checkup: 8, 'ganti sparepart': 7, 'tune up rutin': 8, 'perawatan': 7, 'kilometer': 6 } }
];
...
app.post('/api/ai/diagnose', (req, res) => {
  ...
  let scores = AI_MODEL.map(service => {
    ...
    // Bonus for multiple keyword matches to increase confidence
    if (matches > 1) {
      score += (matches * 2);
    }
  ...
  res.json({
    ...
    confidence: bestMatch.score > 0 ? Math.min(bestMatch.score / 25, 1) : 0,
    version: '4.0-masterpiece'
  });
});
