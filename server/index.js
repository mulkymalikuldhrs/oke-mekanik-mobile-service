...
const AI_MODEL = [
  ...
  { id: 'svc-8', name: 'Isi Freon AC', keywords: { ac: 10, freon: 10, panas: 7, dingin: 8, bau: 5, gerah: 4, 'ac mati': 9, 'nggak dingin': 10, 'kompresor': 6, 'evaporator': 6, 'filter ac': 5, 'blower': 5, 'magnetic clutch': 7 } },
  { id: 'svc-5', name: 'Cek Kelistrikan', keywords: { listrik: 10, lampu: 9, kabel: 8, konslet: 10, sekring: 9, mati: 3, sensor: 7, 'putus': 6, 'korslet': 10, 'ecu': 8, 'koil': 7, 'busi': 8, 'spul': 7, 'wiring': 9, 'harness': 8, 'relay': 7 } },
  { id: 'svc-4', name: 'Tune Up', keywords: { mesin: 9, overheat: 10, asap: 8, brebet: 10, pincang: 10, mati: 5, ngadat: 10, bensin: 4, boros: 6, 'mogok': 10, 'tarikan berat': 9, 'injeksi': 9, 'karburator': 9, 'piston': 8, 'klep': 8, 'radiator': 9, 'kopling': 8, 'transmisi': 7, 'v-belt': 7, 'cvt': 7, 'throtle body': 9, 'carbon clean': 8, 'gurah mesin': 8 } },
