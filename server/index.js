...
const AI_MODEL = [
  ...
  },
  {
    id: 'svc-3',
    name: 'Ganti Ban',
    keywords: { ban: 12, bocor: 11, tire: 12, kempes: 11, gundul: 10, pecah: 9, meletus: 11, 'kurang angin': 7, 'velg': 6, 'pentil': 7, 'tubeless': 8, 'tambal': 10, 'baling': 6, 'spooring': 5, 'balancing': 5, 'benjol': 12, 'makan dalam': 10, 'setir narik': 12, 'getar': 8, 'tekanan ban': 7, 'oleng': 9, 'zig zag': 8, 'ban botak': 11, 'miring': 9 },
  ...
  },
  {
    id: 'svc-4',
    name: 'Tune Up',
    keywords: { mesin: 10, overheat: 12, asap: 10, brebet: 15, berebet: 15, pincang: 15, mati: 6, ngadat: 12, bensin: 6, boros: 11, 'mogok': 12, 'tarikan berat': 12, 'injeksi': 11, 'karburator': 11, 'piston': 10, 'klep': 10, 'radiator': 11, 'kopling': 10, 'transmisi': 9, 'throttle body': 11, 'carbon clean': 10, 'water pump': 11, 'head gasket': 11, 'fan belt': 9, 'ngelitik': 15, 'detonasi': 11, 'asap putih': 13, 'asap hitam': 13, 'nyendal': 12, 'nyentak': 12, 'suara tek tek': 11, 'boros bensin': 14, 'ngeden': 13, 'pagi-pagi susah nyala': 15, 'tunggakan gas': 11, 'idle tidak stabil': 13, 'mesin goyang': 12 },
  ...
  },
  {
    id: 'svc-2',
    name: 'Servis Rutin',
    keywords: { rutin: 12, servis: 12, service: 12, berkala: 11, checkup: 10, 'ganti sparepart': 9, 'maintenance': 11, 'tahunan': 7, 'bulanan': 6, 'perawatan': 9, 'km': 8, 'kilometer': 8, 'inspeksi': 10, 'gluduk': 14, 'kaki-kaki': 13, 'shockbreaker': 12, 'tierod': 11, 'balljoint': 11, 'bunyi mendengung': 12, 'setir goyang': 10, 'bunyi kaki-kaki': 15, 'long tierod': 11, 'link stabil': 11 },
...
app.post('/api/ai/diagnose', (req, res) => {
  ...
  res.json({
    ...
    confidence: bestMatch.score > 0 ? Math.min(Math.round((bestMatch.score / 65) * 100), 99) : 40,
    possible_causes: bestMatch.causes,
    urgency_level: bestMatch.urgency,
    version: 'v5.4.1 ULTIMATE+'
  });
});
