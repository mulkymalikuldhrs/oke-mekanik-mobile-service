...
const AI_MODEL = [
  { id: 'svc-7', name: 'Cek Aki', keywords: { aki: 10, battery: 10, stater: 8, tekor: 9, soak: 10, mati: 2, 'nggak nyala': 7, drop: 8, 'stater berat': 9, 'mati total': 10 } },
  { id: 'svc-1', name: 'Ganti Oli', keywords: { oli: 10, oil: 10, pelumas: 8, bocor: 4, hitam: 5, kental: 5, 'suara kasar': 6, 'mesin panas': 4, 'rembes': 7 } },
  ...
  { id: 'svc-4', name: 'Tune Up', keywords: { mesin: 9, overheat: 10, asap: 8, brebet: 10, pincang: 10, mati: 5, ngadat: 10, bensin: 4, boros: 6, 'mogok': 10, 'tarikan berat': 9, 'ndut-ndutan': 10, 'knocking': 8 } },
