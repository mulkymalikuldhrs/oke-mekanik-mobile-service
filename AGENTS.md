# Oke Mekanik - Masterpiece v28 AI Agent Guidelines
...
## Core Directives
1. **NO MOCKING**: All logic must be real and implemented. Use the Node.js/Express backend and SQLite database. File `db.json` is deprecated and removed.
...
5. **LEGACY CLEANUP**: Keep `src/pages/` free of legacy test files; use `src/__tests__/` for modern, provider-aware testing.

## Architecture
- **Backend**: Node.js + Express 5.2.1
- **Database**: SQLite via `better-sqlite3` 12.9.0
- **AI Engine**: AI Smart Diagnostic v5.4 ULTIMATE (Expanded Technical Mapping)
- **Frontend**: React 19 + Vite + TypeScript
- **Styling**: Tailwind CSS + Framer Motion (160px Glassmorphism)
...
- AI Verification: `node tests/verify_ai_v54.js`
