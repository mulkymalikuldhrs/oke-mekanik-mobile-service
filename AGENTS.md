# Agent Documentation - Production-Ready Full-Stack Implementation

This document provides architectural guidelines and operational instructions for AI agents working on the "Oke Mekanik" codebase.
...
- **NO MOCKS**: Do not use `db.json`, MSW, or local simulations for production-ready features.
- **NO DEGRADATION**: Never downgrade the futuristic UI or remove Framer Motion animations.
- **NO SIMULATIONS**: Features like 'AI Diagnostic' or 'Mechanic Tracking' must be backed by real API endpoints.
