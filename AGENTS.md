# 🤖 Oke Mekanik - AI Agent Guidelines (v5.5.0 ULTIMATE+)
...
- Ensure the `version` property always reflects the current standard (`v5.5.0-ultimate`).

## 🧪 Verification Protocol
Before submitting any work, you MUST run and pass:
1. `node tests/verify_ai_v55.js` - Validates the AI Engine logic.
