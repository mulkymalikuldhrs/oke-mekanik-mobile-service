...
- **Design System**: Consistently use `backdrop-blur-3xl`, `bg-white/[0.03]`, and deep space themes (`#0a0a0a`). Leverage `framer-motion` for all entrance animations and state transitions. Use bold, italic, tracking-tighter typography for primary headers to maintain the futuristic aesthetic.
