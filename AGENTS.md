# AGENTS.md - Masterpiece v28 Ultimate v5.4.1

This document provides instructions for AI agents working on the Oke Mekanik codebase.

## Project Overview
Oke Mekanik is a production-ready mobile mechanic platform connecting customers with professional mechanics in real-time. It features a full-stack architecture with a Node.js/Express backend and an AI Diagnostic Engine v5.4.1 ULTIMATE+.

## Standard & Vision
- **Version**: Masterpiece v28 Ultimate v5.4.1
...
## AI Diagnostic Engine v5.4.1 ULTIMATE+
- Located in `server/index.js`.
- Features advanced technical Indonesian automotive mapping.
- Keywords include: 'brebet', 'pincang', 'ngelitik', 'limp mode', 'asap putih', 'bunyi kaki-kaki', etc.
...
## Verification
- Run `node tests/verify_ai_v54.js` for AI engine verification.
