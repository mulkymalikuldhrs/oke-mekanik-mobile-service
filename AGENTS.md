# 🤖 Oke Mekanik - AI Agent Guidelines (v5.7.0 ULTIMATE+)
...
- Ensure the `version` property always reflects the current standard (`v5.7.0-ultimate`).
