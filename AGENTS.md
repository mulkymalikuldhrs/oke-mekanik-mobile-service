...
- **Analytics**: Keep the Mechanic Dashboard analytics dynamic; calculate metrics from real `bookings` data.
- **Tracking**: Maintain the real-time simulation logic in `TrackingPage.tsx` for visual polish.
