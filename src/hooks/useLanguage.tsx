...
const translations = {
  id: {
    ...
    'hero.subtitle': 'Panggil mekanik profesional masa depan ke lokasi Anda kapan saja, dimana saja. Ekosistem otomotif tercanggih di ujung jari Anda.',
  ...
  en: {
    ...
    'hero.subtitle': 'Call professional futuristic mechanics to your location anytime, anywhere. The most advanced automotive ecosystem at your fingertips.',
