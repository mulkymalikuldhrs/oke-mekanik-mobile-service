    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-blue-500 selection:text-white overflow-x-hidden">
      ...
      <main className="container mx-auto px-4 py-12 md:py-24 relative z-10">
        <div className="text-center mb-16 space-y-6">
          ...
          <h2 className="text-4xl sm:text-6xl md:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-b from-white to-white/40 leading-tight tracking-tighter">
            {t('hero.title')}
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-24 max-w-5xl mx-auto">
          <Card 
            className="group cursor-pointer overflow-hidden border border-white/10 bg-white/5 backdrop-blur-[40px] shadow-2xl hover:bg-white/10 hover:border-blue-500/50 transition-all duration-500"
          ...
          <Card 
            className="group cursor-pointer overflow-hidden border border-white/10 bg-white/5 backdrop-blur-[40px] shadow-2xl hover:bg-white/10 hover:border-orange-500/50 transition-all duration-500"
        ...
        <div className="mb-24">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="border border-white/10 shadow-2xl hover:border-blue-500/50 transition-all duration-500 bg-white/5 backdrop-blur-[40px]">
        ...
        {/* Stats Section */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-24 bg-white/5 backdrop-blur-[40px] p-12 rounded-[3rem] shadow-2xl border border-white/10">
