...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-blue-500/30 overflow-x-hidden font-sans">
      ...
      {/* Futuristic Navbar */}
      <header className="fixed top-0 w-full z-50 border-b border-white/5 bg-black/20 backdrop-blur-ultra">
        <div className="container mx-auto px-4 md:px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Button
              className="bg-blue-600 hover:bg-blue-500 text-white font-bold px-6 rounded-full shadow-lg shadow-blue-500/20"
        ...
        >
          <div className="text-center max-w-4xl mx-auto mb-20">
            ...
            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 justify-center">
               <Button
                 size="lg"
                 className="bg-blue-600 hover:bg-blue-500 h-16 px-10 text-lg font-black rounded-2xl shadow-2xl shadow-blue-500/30 group transition-all"
                 onClick={() => navigate('/register')}
               >
                 Mulai Sekarang
            ...
            <motion.div variants={itemVariants}>
              ...
              >
                ...
                <CardContent className="p-12 text-center">
                  ...
                  <Button className="w-full bg-blue-600 hover:bg-blue-500 h-16 text-lg font-black rounded-2xl shadow-xl shadow-blue-500/20 uppercase tracking-tight">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {features.map((feature, index) => (
                <motion.div key={index} variants={itemVariants}>
                  <Card className="border border-white/5 bg-white/[0.02] backdrop-blur-ultra hover:bg-white/[0.05] hover:border-white/10 transition-all duration-500 group rounded-3xl h-full">
          ...
          >
            {[
              { val: "10k+", label: "Pengguna Aktif", color: "text-blue-400" },
              { val: "500+", label: "Mitra Mekanik", color: "text-orange-400" },
              { val: "4.9", label: "Rating Rata-rata", color: "text-green-400" },
              { val: "15m", label: "Estimasi Tiba", color: "text-purple-400" }
            ].map((stat, i) => (
      ...
      <footer className="bg-black/80 border-t border-white/5 py-20 px-4 relative z-10">
        <div className="container mx-auto grid md:grid-cols-4 gap-12">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-white/40 text-lg max-w-sm leading-relaxed font-medium">
              Revolusi servis kendaraan masa depan. Profesional, transparan, dan instan langsung ke lokasi Anda.
            </p>
          </div>
          <div>
            <h4 className="font-black mb-8 text-white uppercase tracking-widest text-sm">Layanan</h4>
            <ul className="space-y-4 text-white/40 font-medium">
              <li className="hover:text-blue-400 cursor-pointer transition-colors">Panggil Mekanik</li>
              <li className="hover:text-blue-400 cursor-pointer transition-colors">Servis Rutin</li>
              <li className="hover:text-blue-400 cursor-pointer transition-colors">Ganti Oli</li>
              <li className="hover:text-blue-400 cursor-pointer transition-colors">Emergency 24/7</li>
            </ul>
          </div>
          <div>
            <h4 className="font-black mb-8 text-white uppercase tracking-widest text-sm">Hubungi Kami</h4>
            <ul className="space-y-4 text-white/40 font-medium">
        ...
        <div className="container mx-auto mt-20 pt-10 border-t border-white/5 text-center text-white/20 text-sm font-bold tracking-widest uppercase">
          © 2024 Oke Mekanik Masterpiece. All rights reserved.
        </div>
      </footer>
    </div>
  );
