  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-blue-500 selection:text-white overflow-x-hidden font-sans">
      ...
      <div className="fixed top-0 left-0 w-full h-full pointer-events-none z-0">
        <div className="absolute top-[-20%] left-[-20%] w-[80%] h-[80%] bg-blue-600/30 blur-[200px] rounded-full animate-pulse" />
        <div className="absolute bottom-[-20%] right-[-20%] w-[80%] h-[80%] bg-orange-600/20 blur-[200px] rounded-full animate-pulse [animation-delay:2s]" />
        <div className="absolute top-[30%] left-[20%] w-[40%] h-[40%] bg-purple-600/15 blur-[160px] rounded-full animate-pulse [animation-delay:1s]" />
      </div>

      {/* Header */}
      <header className="flex justify-between items-center p-4 md:p-6 sticky top-0 bg-black/40 backdrop-blur-[40px] z-50 border-b border-white/10">
      ...
      <main className="container mx-auto px-4 py-12 md:py-24 relative z-10">
        <div className="text-center mb-16 space-y-6">
          ...
          <motion.h2
            ...
            className="text-4xl sm:text-6xl md:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-b from-white to-white/40 leading-tight tracking-tighter text-glow-blue"
          >
            {t('hero.title')}
          </motion.h2>
          ...
          >
             <Button size="lg" className="bg-blue-600 hover:bg-blue-700 h-16 px-10 text-xl font-bold rounded-full shadow-xl shadow-blue-500/20 hover:shadow-blue-500/40 transition-all active:scale-95" onClick={() => navigate('/register')}>
               Mulai Sekarang <ArrowRight className="ml-2 h-6 w-6" />
             </Button>
          </motion.div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-24 max-w-5xl mx-auto">
          ...
          >
          <Card 
            className="group cursor-pointer overflow-hidden border border-white/10 bg-white/5 backdrop-blur-[40px] shadow-2xl hover:bg-white/10 hover:border-blue-500/50 transition-all duration-500 rounded-[2.5rem]"
          ...
          >
          <Card 
            className="group cursor-pointer overflow-hidden border border-white/10 bg-white/5 backdrop-blur-[40px] shadow-2xl hover:bg-white/10 hover:border-orange-500/50 transition-all duration-500 rounded-[2.5rem]"
        ...
        <div className="mb-24">
          <motion.h3
            ...
            whileInView={{ opacity: 1, scale: 1 }}
            viewport={{ once: true }}
            className="text-4xl md:text-5xl font-black text-center text-white mb-16 italic tracking-tighter"
          >
            {t('features.title')}
          </motion.h3>
        ...
        <div className="text-center bg-gray-900 rounded-[3rem] p-10 md:p-20 text-white relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center relative z-10">
            ...
            <Button 
              size="lg" 
              className="bg-orange-600 text-white hover:bg-orange-700 h-14 px-10 text-lg font-bold border-none"
              onClick={() => handleRoleSelection('mechanic')}
            >
              {t('cta.mechanic')}
            </Button>
