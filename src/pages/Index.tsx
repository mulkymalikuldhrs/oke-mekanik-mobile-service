  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-blue-500 selection:text-white overflow-x-hidden">
      ...
      <main className="container mx-auto px-4 py-12 md:py-24 relative z-10">
        ...
        >
          <div className="inline-flex items-center space-x-2 bg-blue-500/10 text-blue-400 border border-blue-500/20 px-4 py-1 mb-4 backdrop-blur-sm rounded-full">
            <Sparkles className="h-3 w-3 animate-pulse" />
            <span className="text-xs font-bold uppercase tracking-widest">#1 Bengkel Panggilan Indonesia</span>
          </div>
          ...
          <div className="flex justify-center pt-4">
             <Button
                size="lg"
                className="bg-blue-600 hover:bg-blue-500 h-14 px-10 text-lg font-black rounded-2xl shadow-xl shadow-blue-500/30 transition-all hover:scale-105 active:scale-95 italic tracking-tight"
        ...
        <div className="mb-24">
          <motion.h3
            ...
            viewport={{ once: true }}
            className="text-4xl font-black text-center text-white mb-16 tracking-tighter italic"
          >
            {t('features.title')}
          </motion.h3>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <Card className="border border-white/10 shadow-2xl hover:border-blue-500/50 transition-all duration-500 bg-white/5 backdrop-blur-2xl h-full">
