      ...
      <main className="container mx-auto px-6 py-20 relative z-10">
        ...
        <div className="text-center mb-32 space-y-8">
          <motion.div
            ...
            className="inline-flex items-center px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-[40px] mb-6"
          >
          ...
          >
            {t('hero.title.v27.part1')}<br />
            <span className="text-blue-500">{t('hero.title.v27.part2')}</span>
          </motion.h2>
          ...
          >
             ...
             <Button
               size="lg"
               variant="outline"
               className="border-white/10 bg-white/5 hover:bg-white/10 backdrop-blur-[40px] h-16 px-10 text-lg font-bold rounded-2xl"
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="p-8 rounded-[2rem] bg-white/5 border border-white/10 backdrop-blur-[40px] hover:bg-white/10 transition-colors"
              >
        ...
        {/* Dynamic Stats */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-40 p-12 rounded-[3rem] bg-white/5 border border-white/10 backdrop-blur-[40px]">
          {[
