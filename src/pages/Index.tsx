    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-blue-500 selection:text-white overflow-x-hidden">
      ...
      <main className="container mx-auto px-4 py-12 md:py-24 relative z-10">
        ...
        <div className="mb-24 relative z-10">
          <h3 className="text-4xl md:text-5xl font-black text-center text-white mb-16 tracking-tight">
            {t('features.title')}
          </h3>
      ...
      {/* Footer */}
      <footer className="bg-black/60 backdrop-blur-3xl border-t border-white/10 py-12 px-4 relative z-10">
