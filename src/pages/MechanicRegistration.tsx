...
const MechanicRegistration = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-orange-500 p-4 flex items-center justify-center relative overflow-hidden">
      ...
      <Card className="w-full max-w-lg bg-black/40 border-white/10 backdrop-blur-[160px] shadow-2xl relative z-10 overflow-hidden rounded-[2.5rem]">
        ...
        <CardFooter className="bg-black/20 text-center py-6 border-t border-white/5 flex justify-center">
