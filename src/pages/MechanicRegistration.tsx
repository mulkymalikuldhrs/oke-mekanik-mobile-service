...
const MechanicRegistration = () => {
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="experience"
                  type="number"
                  placeholder={t('mechanic.reg.exp_placeholder')}
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  id="phone"
                  placeholder={t('mechanic.reg.phone_placeholder')}
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="identity"
                  placeholder={t('mechanic.reg.id_placeholder')}
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="bio"
                  placeholder={t('mechanic.reg.bio_placeholder')}
                  value={formData.bio}
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
            ...
            <div className="grid grid-cols-1 gap-4">
              <div className="border-2 border-dashed border-white/10 rounded-2xl p-8 text-center hover:bg-white/5 hover:border-orange-500/30 cursor-pointer transition-all group">
                ...
                <p className="text-xs text-gray-500 mt-1">{t('common.format_image')}</p>
              </div>
              <div className="border-2 border-dashed border-white/10 rounded-2xl p-8 text-center hover:bg-white/5 hover:border-blue-500/30 cursor-pointer transition-all group">
                ...
                <p className="text-xs text-gray-500 mt-1">{t('common.optional_verify')}</p>
              </div>
            </div>
          </div>
        );
      case 4:
        return (
          <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
            ...
            <div className="bg-orange-500/10 p-6 rounded-2xl border border-orange-500/20 backdrop-blur-[160px]">
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-orange-500 p-4 flex items-center justify-center relative overflow-hidden">
      ...
      <Card className="w-full max-w-lg bg-white/5 border-white/10 backdrop-blur-[160px] shadow-2xl relative z-10 overflow-hidden">
        ...
        <CardFooter className="bg-white/5 text-center py-6 border-t border-white/5 flex justify-center backdrop-blur-[160px]">
