  ...
  const renderStep = () => {
    switch (step) {
      ...
      case 2:
        return (
          <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
            <h3 className="text-xl font-black italic tracking-tight text-orange-400 uppercase">Informasi Kontak & Identitas</h3>
            <div className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="phone" className="text-gray-300">Nomor Telepon Aktif</Label>
                <Input
                  id="phone"
                  placeholder="0812..."
              ...
              <div className="space-y-2">
                <Label htmlFor="identity" className="text-gray-300">Nomor KTP / NIK</Label>
                <Input
                  id="identity"
                  placeholder="3201..."
              ...
              <div className="space-y-2">
                <Label htmlFor="bio" className="text-gray-300">Biografi Singkat</Label>
                <Input
                  id="bio"
