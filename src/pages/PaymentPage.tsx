      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          {paymentStatus === 'processing' && (
            <Card className="glass-card p-16 text-center shadow-2xl">
               <div className="relative inline-block mb-6">
                 <div className="absolute inset-0 bg-blue-500/20 blur-xl rounded-full animate-pulse" />
                 <LoaderCircle className="h-20 w-20 text-blue-500 relative animate-spin" />
               </div>
               <h3 className="text-3xl font-black italic tracking-tighter uppercase">MEMPROSES PEMBAYARAN...</h3>
               <p className="text-gray-400 mt-2 font-medium italic">Mohon jangan tutup halaman ini sampai konfirmasi selesai.</p>
            </Card>
          )}

          {paymentStatus === 'completed' && (
            <Card className="glass-card p-16 text-center space-y-8 shadow-2xl animate-in zoom-in-95 duration-500 relative overflow-hidden">
