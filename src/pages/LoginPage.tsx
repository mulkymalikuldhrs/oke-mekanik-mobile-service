...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0a0a0a] px-4 relative overflow-hidden">
      ...
      >
        <Card className="border-white/10 bg-black/40 backdrop-blur-[40px] shadow-2xl relative z-10 rounded-[2rem] overflow-hidden">
          ...
          <CardHeader className="text-center pb-2">
            <div className="flex justify-center mb-6">
              <motion.div
                ...
                className="bg-blue-600 p-3 rounded-2xl shadow-lg shadow-blue-500/20"
              >
          ...
          <form onSubmit={handleSubmit}>
            <CardContent className="space-y-5 pt-4">
              ...
              <div className="space-y-2">
                ...
                <Select value={role} onValueChange={(val) => setRole(val as UserRole)}>
                  ...
                  <SelectContent className="bg-[#1a1a1a] border-white/10 text-white backdrop-blur-xl">
            ...
            <CardFooter className="flex flex-col space-y-6 pb-10 pt-4">
              <Button type="submit" className="w-full bg-blue-600 hover:bg-blue-500 text-white font-black h-14 rounded-xl shadow-xl shadow-blue-500/20 text-lg uppercase tracking-tight transition-all active:scale-95" disabled={isLoading}>
