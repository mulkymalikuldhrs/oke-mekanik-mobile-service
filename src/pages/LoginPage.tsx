...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0a0a0a] px-4 relative overflow-hidden">
      ...
      <Card className="w-full max-w-md border-white/10 bg-black/40 backdrop-blur-[40px] shadow-2xl relative z-10 rounded-[2rem] overflow-hidden">
        ...
        <CardHeader className="text-center pb-2">
          ...
          <CardDescription className="text-gray-400 font-medium">Masuk ke akun Anda</CardDescription>
        </CardHeader>
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-5 pt-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="role" className="text-gray-300 ml-1">Masuk sebagai</Label>
