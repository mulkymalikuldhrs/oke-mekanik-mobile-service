        ...
        <div className="space-y-3">
          ...
          <AnimatePresence>
            {isAnalyzing && (
              ...
              >
                <div className="bg-blue-600/10 border border-blue-500/20 p-4 rounded-2xl flex items-center space-x-4 mb-4 relative overflow-hidden group">
                  ...
                  <div className="flex-1 relative z-10">
                    <div className="flex justify-between items-center mb-2">
                      <p className="text-[10px] text-blue-300 font-mono uppercase tracking-[0.2em] animate-pulse">Neural Engine Processing...</p>
                      <span className="text-[10px] text-blue-400 font-mono">0x7F...9A</span>
                    </div>
                    <div className="h-2 w-full bg-blue-900/30 rounded-full overflow-hidden border border-blue-500/10">
                      <motion.div
          ...
          <AnimatePresence>
            {aiSuggestion && !isAnalyzing && (
              <motion.div
                ...
                className="bg-green-500/10 border border-green-500/20 p-4 rounded-2xl mb-4 flex items-center space-x-3"
              >
                <div className="bg-green-500/20 p-2 rounded-xl">
                  <Sparkles className="h-5 w-5 text-green-400" />
                </div>
                <div>
                  <p className="text-[10px] text-green-500 font-black uppercase tracking-widest">AI Rekomendasi</p>
                  <p className="text-sm font-bold text-white">{aiSuggestion}</p>
                </div>
              </motion.div>
            )}
          </AnimatePresence>
