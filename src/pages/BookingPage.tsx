  ...
  const handleAiDiagnostic = () => {
    ...
    setTimeout(() => {
      ...
      if (problem.includes('aki') || problem.includes('battery') || problem.includes('stater') || problem.includes('soak')) {
        suggestion = "Cek Aki";
        serviceId = "svc-7";
      } else if (problem.includes('oli') || problem.includes('oil') || problem.includes('pelumas') || problem.includes('tune up')) {
        suggestion = "Ganti Oli";
        serviceId = "svc-1";
      } else if (problem.includes('ban') || problem.includes('bocor') || problem.includes('tire') || problem.includes('pecah')) {
        ...
        serviceId = "svc-8";
      } else if (problem.includes('listrik') || problem.includes('lampu') || problem.includes('kabel') || problem.includes('mati total')) {
        suggestion = "Cek Kelistrikan";
        serviceId = "svc-5";
      } else if (problem.includes('mesin') || problem.includes('pincang') || problem.includes('overheat') || problem.includes('asap')) {
        suggestion = "Servis Mesin";
        serviceId = "svc-2";
      }
