...
const BookingPage = () => {
  ...
  const handleAiDiagnostic = () => {
    ...
    setTimeout(() => {
      ...
      if (problem.includes('aki') || problem.includes('battery') || problem.includes('stater') || problem.includes('soak')) {
        suggestion = "Cek Aki";
      ...
      } else if (problem.includes('rem') || problem.includes('brake') || problem.includes('cit') || problem.includes('keras')) {
      ...
      } else if (problem.includes('listrik') || problem.includes('lampu') || problem.includes('kabel')) {
        suggestion = "Cek Kelistrikan";
      } else if (problem.includes('pincang') || problem.includes('mati') || problem.includes('asap') || problem.includes('overheat') || problem.includes('ngadat')) {
        suggestion = "Tune Up";
      }
