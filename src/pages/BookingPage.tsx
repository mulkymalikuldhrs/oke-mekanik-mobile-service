              ...
              >
                <div className="bg-blue-600/10 border border-blue-500/20 p-3 rounded-xl flex items-center space-x-3 mb-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-[10px] text-blue-300 mt-1 font-mono uppercase tracking-widest animate-pulse">{t('common.analyzing')}</p>
                  </div>
                </div>
              </motion.div>
            )}
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-blue-500 p-4 md:p-8 relative overflow-hidden">
      ...
      <div className="fixed top-0 left-0 w-full h-full pointer-events-none z-0">
        <div className="absolute top-[20%] right-[-10%] w-[40%] h-[40%] bg-blue-600/20 blur-[160px] rounded-full" />
        <div className="absolute bottom-[20%] left-[-10%] w-[40%] h-[40%] bg-blue-600/10 blur-[160px] rounded-full" />
      </div>
