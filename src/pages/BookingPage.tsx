  ...
  const handleAiDiagnostic = () => {
    ...
    setTimeout(() => {
      ...
      if (problem.includes('aki') || problem.includes('battery') || problem.includes('stater') || problem.includes('soak')) {
        ...
        serviceId = "svc-8";
      } else if (problem.includes('listrik') || problem.includes('lampu') || problem.includes('kabel') || problem.includes('sekring')) {
        suggestion = "Cek Kelistrikan";
        serviceId = "svc-5";
      } else if (problem.includes('pincang') || problem.includes('mati') || problem.includes('asap') || problem.includes('overheat') || problem.includes('brebet') || problem.includes('tenaga')) {
        suggestion = "Tune Up";
        serviceId = "svc-4";
      }
