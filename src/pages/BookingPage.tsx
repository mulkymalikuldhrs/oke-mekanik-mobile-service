...
const BookingPage = () => {
  ...
  const [location, setLocation] = useState<LocationData>({ address: '', lat: -6.2088, lng: 106.8456 });
            ...
            <Button
              ...
              onClick={() => {
                navigator.geolocation.getCurrentPosition((pos) => {
                   ...
                   toast({ title: "Lokasi Diperbarui", description: "Koordinat GPS telah disinkronkan." });
                });
              }}
            >
