...
const BookingPage = () => {
  ...
  const handleAiDiagnostic = async () => {
    ...
    try {
      const { suggestion, serviceId } = await serviceApi.diagnose(vehicleData.problem);

      // Delay slightly for UX/animation
      ...
      toast({
        title: 'Analisa Gagal',
        description: 'Gagal menghubungi asisten AI. Silakan pilih layanan secara manual.',
        variant: 'destructive',
      });
    }
  };
