...
const BookingPage = () => {
  ...
  const handleAiDiagnostic = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: 'Terjadi kesalahan saat menghubungi sistem diagnosa.',
        variant: 'destructive'
      });
    } finally {
  ...
  const renderLocationStep = () => (
    <Card className="glass-card text-white overflow-hidden relative">
      <div className={`absolute inset-0 bg-blue-500/5 pointer-events-none ${isAnalyzing ? 'animate-scan' : ''}`} />
      <CardHeader>
