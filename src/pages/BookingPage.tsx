...
const BookingPage = () => {
  ...
  const handleAiDiagnostic = () => {
    ...
    setTimeout(() => {
      ...
      if (problem.includes('pincang') || problem.includes('mati') || problem.includes('asap') || problem.includes('overheat') || problem.includes('brebet')) {
        suggestion = "Tune Up";
        serviceId = "svc-4";
      } else if (problem.includes('aki') || problem.includes('battery') || problem.includes('stater') || problem.includes('soak')) {
        suggestion = "Cek Aki";
        serviceId = "svc-7";
