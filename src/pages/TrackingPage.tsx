  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-blue-500 overflow-x-hidden">
      ...
      <main className="container mx-auto px-4 py-8 space-y-8 relative z-10">
        {/* Real-time Map Card */}
        <Card className="glass-card shadow-2xl overflow-hidden group">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          {booking.status === 'completed' ? (
            <Card className="glass-card border-green-500/30 shadow-2xl animate-in zoom-in-95 duration-500">
              <CardHeader>
      ...
      {/* Footer Meta */}
      <footer className="mt-12 p-8 border-t border-white/5 bg-black/40 backdrop-blur-[40px]">
