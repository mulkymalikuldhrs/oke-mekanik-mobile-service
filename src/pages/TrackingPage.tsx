...
import { MapPin, Phone, MessageSquare, CheckCircle, AlertCircle, Navigation, ShieldCheck, ArrowLeft, LoaderCircle, Star } from 'lucide-react';
            ...
            <div className="w-full h-96 relative z-10">
              {booking?.location?.lat && booking?.location?.lng ? (
                ...
                >
                  ...
                  {mechanicPos && (booking.status === 'otw' || booking.status === 'working') ? (
                    <Marker
