...
const TrackingPage = () => {
  ...
  const mechanicPos: [number, number] | null = booking?.mechanicLocation
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-blue-500 overflow-x-hidden">
      ...
      <main className="container mx-auto px-4 py-8 space-y-8 relative z-10">
        {/* Real-time Map Card */}
        <Card className="bg-white/5 border-white/10 backdrop-blur-[40px] shadow-2xl overflow-hidden group rounded-[2.5rem] relative">
        ...
        {/* Status Progress */}
        <Card className="bg-white/5 border-white/10 backdrop-blur-[40px] shadow-xl rounded-[2rem]">
          <CardHeader>
