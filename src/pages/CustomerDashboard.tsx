...
const CustomerDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-blue-500">
      ...
      {/* Header */}
      <header className="bg-black/40 backdrop-blur-ultra border-b border-white/10 sticky top-0 z-50">
      ...
      <div className="container mx-auto p-4 space-y-6 relative z-10">
        ...
        >
          <Card className="bg-gradient-to-br from-blue-600/20 to-blue-900/40 border border-blue-500/30 backdrop-blur-ultra shadow-2xl overflow-hidden group relative">
        ...
        {activeBooking && (
          <motion.div
            ...
            className="relative"
          >
          <Card className="border-orange-500/50 bg-orange-500/10 backdrop-blur-ultra relative overflow-hidden shadow-[0_0_20px_rgba(249,115,22,0.2)] animate-pulse-border">
        ...
        >
        <Card className="glass-card relative overflow-hidden hover:border-blue-500/50 transition-all duration-500 backdrop-blur-ultra border-white/10">
        ...
        >
        <Card className="glass-card backdrop-blur-ultra border-white/10">
          <CardHeader>
