  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-blue-500">
      ...
      <div className="container mx-auto p-4 space-y-6 relative z-10">
        ...
        >
        <Card className="bg-white/5 backdrop-blur-[40px] border-white/20 shadow-2xl relative overflow-hidden hover:border-blue-500/50 transition-all duration-700 group">
