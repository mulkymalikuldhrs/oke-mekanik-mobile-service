  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-blue-500">
      ...
      <div className="container mx-auto p-4 space-y-6 relative z-10">
        ...
        >
        <Card className="glass-card backdrop-blur-[40px] relative overflow-hidden hover:border-blue-500/50 transition-all duration-700 group">
            ...
            {isLoadingMechanics ? (
              ...
              {nearbyMechanics.slice(0, 5).map((mechanic, index) => (
                <motion.div
                  ...
                  className="flex items-center justify-between p-4 border border-white/5 rounded-2xl hover:bg-white/5 transition-colors"
                >
                  <div className="flex items-center space-x-4">
        ...
        >
        <Card className="glass-card backdrop-blur-[40px] shadow-2xl">
          <CardHeader>
            ...
            {isLoadingBookings ? (
              ...
              {recentBookings.map((booking, index) => (
                <motion.div
                  ...
                  className="flex items-center justify-between p-4 border border-white/5 rounded-2xl"
                >
                  <div>
