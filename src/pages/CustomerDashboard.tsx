  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-blue-500">
      ...
      <div className="container mx-auto p-4 space-y-6 relative z-10">
        ...
        >
          <Card className="bg-gradient-to-br from-blue-600/20 to-blue-900/40 border border-blue-500/30 backdrop-blur-[160px] shadow-2xl overflow-hidden group relative">
        ...
        >
        <Card className="glass-card relative overflow-hidden hover:border-blue-500/50 transition-all duration-500 border-white/10">
