  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-blue-500">
      ...
      <div className="container mx-auto p-4 space-y-6 relative z-10">
        ...
        >
        <Card className="bg-white/5 backdrop-blur-[40px] border-white/10 shadow-2xl">
          <CardHeader>
      ...
      <Dialog open={reviewDialogOpen} onOpenChange={setReviewDialogOpen}>
        <DialogContent className="bg-[#1a1a1a]/80 border-white/10 text-white backdrop-blur-[40px]">
          <DialogHeader>
