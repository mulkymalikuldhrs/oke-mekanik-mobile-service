      ...
      <div className="container mx-auto p-4 space-y-6 relative z-10">
        ...
        >
          ...
          <CardContent className="p-8 relative z-10">
            <h2 className="text-4xl font-black mb-4 text-transparent bg-clip-text bg-gradient-to-r from-white to-white/60 tracking-tighter italic">{t('dashboard.customer.help_title')}</h2>
            <p className="mb-8 text-gray-300 text-lg font-medium">{t('dashboard.customer.help_subtitle')}</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <Button 
                size="lg" 
                className="bg-blue-600 hover:bg-blue-500 text-white font-black rounded-2xl h-16 text-xl shadow-xl shadow-blue-500/30 transition-all active:scale-95 holographic-glow"
