  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-blue-500">
      ...
      <div className="container mx-auto p-4 space-y-6 relative z-10">
        ...
        >
          <Card className="bg-gradient-to-br from-blue-600/20 to-blue-900/40 border border-blue-500/30 backdrop-blur-2xl shadow-2xl overflow-hidden group relative">
          ...
          <CardContent className="p-8 relative z-10">
            <h2 className="text-4xl font-black mb-4 text-transparent bg-clip-text bg-gradient-to-r from-white to-white/60 tracking-tighter italic uppercase">{t('dashboard.customer.help')}</h2>
            <p className="mb-8 text-gray-300 text-lg font-medium">{t('dashboard.customer.help_desc')}</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              >
                ...
                {t('dashboard.customer.emergency')}
              </Button>
            </div>
          </CardContent>
        </Card>
        ...
        {activeBooking && (
          <motion.div
            ...
            className="relative"
          >
          <Card className="border-orange-500/50 bg-orange-500/10 backdrop-blur-2xl relative overflow-hidden shadow-[0_0_20px_rgba(249,115,22,0.2)] animate-pulse-border">
            ...
            <CardHeader>
              <CardTitle className="flex items-center text-orange-400">
                ...
                {t('dashboard.customer.active_service')} - {t(`status.${activeBooking.status}`)}
              </CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <Card className="bg-white/5 backdrop-blur-2xl border-white/10 shadow-2xl relative overflow-hidden hover:border-blue-500/50 transition-all duration-500">
          ...
          <CardHeader>
            <CardTitle className="flex items-center text-xl font-black text-white italic tracking-tight uppercase">
              ...
              {t('dashboard.customer.nearby_mechanics')}
            </CardTitle>
          </CardHeader>
        ...
        <Card className="bg-white/5 backdrop-blur-xl border-white/10 shadow-2xl">
          <CardHeader>
            <CardTitle className="flex items-center text-lg text-white">
              ...
              {t('dashboard.customer.service_history')}
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            {isLoadingBookings ? (
