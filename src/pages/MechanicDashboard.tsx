    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-orange-500">
      ...
      <main className="container mx-auto px-4 py-8 relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <Card className="bg-white/5 backdrop-blur-2xl border-white/10 hover:border-orange-500/30 transition-all duration-500 group h-full">
            <CardContent className="p-4 text-center">
              <p className="text-3xl font-black text-orange-400 group-hover:scale-110 transition-transform">{pendingOrders.length}</p>
              <p className="text-xs font-bold uppercase tracking-widest text-gray-500 mt-1">{t('dashboard.mechanic.orders')}</p>
            </CardContent>
          </Card>
          </motion.div>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }}>
          <Card className="bg-white/5 backdrop-blur-2xl border-white/10 hover:border-blue-500/30 transition-all duration-500 group h-full">
            <CardContent className="p-4 text-center">
          ...
          <Card className="bg-white/5 backdrop-blur-2xl border-white/10 hover:border-green-500/30 transition-all duration-500 group h-full">
            <CardContent className="p-4 text-center">
          ...
          <Card className="bg-white/5 backdrop-blur-2xl border-white/10 hover:border-yellow-500/30 transition-all duration-500 group h-full">
            <CardContent className="p-4 text-center">
        ...
        {currentJob && (
          ...
          <Card className="mb-8 bg-orange-500/10 backdrop-blur-xl border-orange-500/50 shadow-[0_0_20px_rgba(249,115,22,0.15)]">
            <CardHeader>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          ...
          <Card className="bg-white/5 backdrop-blur-2xl border-white/10 shadow-2xl relative overflow-hidden hover:border-orange-500/50 transition-all duration-500">
            <div className="absolute top-0 right-0 p-4">
              <TrendingUp className="h-6 w-6 text-orange-500 opacity-50" />
            </div>
            <CardHeader>
              <CardTitle className="text-xl font-black text-white italic tracking-tight uppercase">{t('dashboard.mechanic.earnings_analysis')}</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-white/5 backdrop-blur-2xl border-white/10 shadow-2xl overflow-hidden hover:border-yellow-500/50 transition-all duration-500 h-full">
            <CardHeader>
              <CardTitle className="text-xl font-black text-white italic tracking-tight uppercase">{t('dashboard.mechanic.performance_trends')}</CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <Card className="bg-white/5 backdrop-blur-2xl border-white/10 shadow-2xl relative overflow-hidden hover:border-blue-500/50 transition-all duration-500">
          ...
          <CardHeader>
            <CardTitle className="flex items-center text-xl font-black text-white italic tracking-tight uppercase">
              ...
              {t('dashboard.mechanic.orders')} ({pendingOrders.length})
            </CardTitle>
          </CardHeader>
