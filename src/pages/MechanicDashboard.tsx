...
const MechanicDashboard = () => {
  ...
  // Analytics data - calculate total from completed jobs
  ...
  const chartData = [
    ...
    { name: 'Jum', value: 850000 + (completedJobsCount > 0 ? 50000 : 0) },
          ...
          <Card className="lg:col-span-2 bg-white/5 backdrop-blur-2xl border-white/10 shadow-2xl relative overflow-hidden">
            ...
            <CardContent>
              ...
              <div className="mt-4 flex justify-between items-end">
                <div>
                  <p className="text-xs font-bold text-gray-500 uppercase tracking-widest">Total Estimasi Pendapatan</p>
                  <p className="text-2xl font-black text-white">Rp {(4550000 + totalEarnings).toLocaleString()}</p>
                </div>
                <Badge className="bg-green-500/20 text-green-400 border-green-500/30">Target: Rp 10.000.000</Badge>
              </div>
            </CardContent>
          </Card>
