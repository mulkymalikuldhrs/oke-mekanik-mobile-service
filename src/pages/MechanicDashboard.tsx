...
const MechanicDashboard = () => {
  ...
  const getRatingTrends = () => {
    if (!reviews || reviews.length === 0) {
      return [
        { name: t('months.jan'), rating: 4.5 },
        { name: t('months.feb'), rating: 4.6 },
        { name: t('months.mar'), rating: 4.8 },
      ];
    }
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-orange-500">
      ...
      <div className="fixed top-0 left-0 w-full h-full pointer-events-none z-0">
        <div className="absolute top-[10%] right-[-10%] w-[50%] h-[50%] bg-orange-600/20 blur-[160px] rounded-full animate-pulse" />
        <div className="absolute bottom-[10%] left-[-10%] w-[50%] h-[50%] bg-orange-600/10 blur-[160px] rounded-full animate-pulse [animation-delay:2s]" />
      </div>
      ...
      <header className="bg-black/40 backdrop-blur-[40px] border-b border-white/10 sticky top-0 z-50">
        <div className="flex justify-between items-center p-4 md:px-8">
          ...
          <div className="flex items-center space-x-4">
            <div className="hidden md:flex items-center space-x-3 bg-white/5 border border-white/10 rounded-full px-4 py-1.5 backdrop-blur-[40px]">
      ...
      <main className="container mx-auto px-4 py-8 relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <Card className="glass-card hover:border-orange-500/30 transition-all duration-500 group h-full backdrop-blur-[40px]">
          ...
          <Card className="glass-card hover:border-blue-500/30 transition-all duration-500 group h-full backdrop-blur-[40px]">
            <CardContent className="p-4 text-center">
          ...
          <Card className="glass-card hover:border-green-500/30 transition-all duration-500 group h-full backdrop-blur-[40px]">
            <CardContent className="p-4 text-center">
          ...
          <Card className="glass-card hover:border-yellow-500/30 transition-all duration-500 group h-full backdrop-blur-[40px]">
            <CardContent className="p-4 text-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          ...
          <Card className="glass-card relative overflow-hidden hover:border-orange-500/50 transition-all duration-500 backdrop-blur-[40px]">
          ...
          <Card className="glass-card overflow-hidden hover:border-yellow-500/50 transition-all duration-500 h-full backdrop-blur-[40px]">
            <CardHeader>
        ...
        <Card className="glass-card relative overflow-hidden hover:border-blue-500/50 transition-all duration-500 backdrop-blur-[40px]">
