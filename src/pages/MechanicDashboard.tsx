    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-orange-500">
      ...
      <main className="container mx-auto px-4 py-8 relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <Card className="bg-white/5 backdrop-blur-[40px] border-white/10 hover:border-orange-500/30 transition-all duration-500 group h-full">
          ...
          <Card className="bg-white/5 backdrop-blur-[40px] border-white/10 hover:border-blue-500/30 transition-all duration-500 group h-full">
            <CardContent className="p-4 text-center">
          ...
          <Card className="bg-white/5 backdrop-blur-[40px] border-white/10 hover:border-green-500/30 transition-all duration-500 group h-full">
            <CardContent className="p-4 text-center">
          ...
          <Card className="bg-white/5 backdrop-blur-[40px] border-white/10 hover:border-yellow-500/30 transition-all duration-500 group h-full">
            <CardContent className="p-4 text-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          ...
          <Card className="bg-white/5 backdrop-blur-[40px] border-white/10 shadow-2xl relative overflow-hidden hover:border-orange-500/50 transition-all duration-500">
          ...
          <Card className="bg-white/5 backdrop-blur-[40px] border-white/10 shadow-2xl overflow-hidden hover:border-yellow-500/50 transition-all duration-500 h-full">
            <CardHeader>
        ...
        <Card className="bg-white/5 backdrop-blur-[40px] border-white/10 shadow-2xl relative overflow-hidden hover:border-blue-500/50 transition-all duration-500">
