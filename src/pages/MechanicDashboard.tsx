    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-orange-500">
      ...
      <main className="container mx-auto px-4 py-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          ...
          <Card className="glass-card backdrop-blur-[40px] shadow-2xl relative overflow-hidden hover:border-orange-500/50 transition-all duration-500">
        ...
        <Card className="glass-card backdrop-blur-[40px] shadow-2xl relative overflow-hidden hover:border-blue-500/50 transition-all duration-500">
