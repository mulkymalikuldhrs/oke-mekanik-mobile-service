    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-orange-500">
      ...
      <main className="container mx-auto px-4 py-8 relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <Card className="glass-card hover:border-orange-500/50 transition-all duration-500 group h-full rounded-3xl">
            ...
            <CardContent>
              ...
              <div className="flex space-x-2 mt-4">
                ...
                {currentJob.status === 'otw' && (
                    <Button size="sm" className="bg-indigo-600 hover:bg-indigo-700 text-white" onClick={() => updateStatusMutation.mutate({ id: currentJob.id, status: 'arrived' })}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          ...
          <Card className="glass-card relative overflow-hidden hover:border-orange-500/50 transition-all duration-500 rounded-[2.5rem]">
        ...
        <Card className="glass-card relative overflow-hidden hover:border-blue-500/50 transition-all duration-500 p-2 sm:p-4">
            ...
            {pendingOrders.length > 0 ? (
              pendingOrders.map((order, index) => (
                <motion.div
                  ...
                  className="border border-white/5 rounded-2xl p-4 hover:bg-white/5 transition-colors"
                >
                  <div className="flex justify-between items-start">
                    <div>
