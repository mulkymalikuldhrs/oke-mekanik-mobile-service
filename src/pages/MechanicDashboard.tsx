      ...
      <main className="container mx-auto px-4 py-8 relative z-10">
            ...
            <CardContent>
              ...
              <div className="flex space-x-2 mt-4">
                ...
                {currentJob.status === 'working' && (
                  <Button size="sm" className="bg-green-600 hover:bg-green-700 text-white font-black holographic-glow" onClick={() => handleCompleteJob(currentJob.id)}>
                    <CheckCircle className="h-4 w-4 mr-1" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          ...
          <Card className="glass-card relative overflow-hidden hover:border-orange-500/50 transition-all duration-500">
            ...
            <CardHeader>
              <CardTitle className="text-xl font-black text-white italic tracking-tight">{t('dashboard.mechanic.analytics')}</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="glass-card overflow-hidden hover:border-yellow-500/50 transition-all duration-500 h-full">
            <CardHeader>
              <CardTitle className="text-xl font-black text-white italic tracking-tight">{t('dashboard.mechanic.performance')}</CardTitle>
            </CardHeader>
            <CardContent>
